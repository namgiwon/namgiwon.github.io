...
```javascript
var messageTotalCount = 101;
var messagePerPage = 10;
var pageTotalCount = 0;
var pagePerGroup = 10;
var lastGroup = Math.floor(messageTotalCount / messagePerPage);
...
if((pageGroup == 0 && pageTotalCount > pagePerGroup) || (pageGroup != 0 && pageTotalCount > pagePerGroup)) {
